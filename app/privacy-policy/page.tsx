...
export const metadata: Metadata = {
  ...
  description:
    'Learn how Marketing Analytics collects, uses, and protects your advertising data across Google Ads, Meta Ads, and LinkedIn Ads.',
}
      ...
      <div className="container mx-auto max-w-4xl px-6 py-16">
        <div className="space-y-6 rounded-2xl bg-gray-900/90 p-8 shadow-xl backdrop-blur-sm border border-white/10">
          ...
          <p className="text-base leading-relaxed text-gray-300">
            Marketing Analytics (&ldquo;the Service&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) helps
