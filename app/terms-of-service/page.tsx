...
export const metadata: Metadata = {
  title: 'Terms of Service | Marketing Analytics Chatbot',
  description:
    'Review the contractual terms governing your use of the Marketing Analytics Chatbot platform, including acceptable use, account responsibilities, and service commitments.',
}
        ...
        <div className="space-y-6 rounded-2xl bg-white/90 p-8 shadow-xl backdrop-blur-sm dark:bg-gray-900/90">
          <header className="space-y-2 text-left">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
              Agreement for Using Marketing Analytics Chatbot
            </h1>
          ...
          <p className="text-base leading-relaxed text-gray-600 dark:text-gray-300">
            ...
            Chatbot platform, including any dashboards, APIs, and documentation (collectively, the
