...
function ClientDetailPage() {
    ...
    const handleExportExcel = ()=>{
        ...
        const range = datePreset === 'custom' ? customDateRange : getDateRangeFromPreset(datePreset);
        const wb = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$reports$2f$generator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateClientExcel"])(client.name, reportMetrics, campaignData, performanceData, {
            start: range.startDate,
            end: range.endDate
        });
