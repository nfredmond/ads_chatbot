...
"[project]/lib/google-ads/client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getGoogleAdsAccessToken(clientId, clientSecret, refreshToken) {
    try {
        ...
        if (!response.ok) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logTokenRefresh"])('google_ads', false, undefined, new Error(errorMessage));
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('google_ads', 'refreshToken', new Error(errorMessage), response.status, data.error);
        }
        if (!data.access_token) {
            const error = new Error('No access token returned from Google OAuth refresh flow');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logTokenRefresh"])('google_ads', false, undefined, error);
            throw error;
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logTokenRefresh"])('google_ads', true);
 ...
 */ async function listAccessibleCustomers(accessToken, developerToken) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('Found accessible customer accounts', {
 ...
 */ async function listClientAccounts(managerCustomerId, accessToken, developerToken) {
    const query = `
    SELECT 
  ...
  `;
    ...
    for (const row of rows){
        ...
        if (clientCustomer && !isManager) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info(`Found client account: ${name} (${clientId})`);
        }
    }
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('Found client accounts under manager', {
 ...
 */ async function isManagerAccount(customerId, accessToken, developerToken, loginCustomerId) {
 ...
 */ async function fetchCampaignsFromCustomer(customerId, accessToken, developerToken, loginCustomerId) {
    const query = `
    SELECT
      campaign.id,
      campaign.name,
  ...
  `;
    ...
    if (!response.ok) {
        ...
        if (errorCode?.queryError === 'REQUESTED_METRICS_FOR_MANAGER') {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info(`Skipping manager account ${customerId}`);
            return {
                results: [],
                isManager: true
            };
...
async function fetchGoogleAdsCampaigns(config) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('Fetching Google Ads campaigns', {
        customerId,
        loginCustomerId
    });
    const accessToken = await getGoogleAdsAccessToken(config.clientId, config.clientSecret, config.refreshToken);
    // First, try to fetch directly from the provided customer ID
    const directResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rate$2d$limiting$2f$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRateLimit"])('google_ads', async ()=>{
    ...
    if (!directResult.isManager && directResult.results?.length > 0) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAPISuccess"])('google_ads', 'fetchCampaigns', {
            resultCount,
            customerId
        });
        return directResult;
    ...
    if (directResult.isManager) {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('Detected manager account, listing client accounts...');
        ...
        if (clientAccounts.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('No clients from CustomerClient, trying listAccessibleCustomers...');
            const accessibleCustomers = await listAccessibleCustomers(accessToken, config.developerToken);
            clientAccounts = accessibleCustomers.filter((id)=>id !== customerId).map((id)=>({
                    id,
                    name: `Account ${id}`
                }));
        }
        if (clientAccounts.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].warn('No client accounts found under manager account');
            return {
                results: [],
                clientAccounts: []
            };
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info(`Found ${clientAccounts.length} client accounts, fetching campaigns...`);
        // Fetch campaigns from each client account
        const allResults = [];
        for (const client of clientAccounts){
            try {
                const clientResult = await fetchCampaignsFromCustomer(client.id, accessToken, config.developerToken, loginCustomerId);
                if (clientResult.results && !clientResult.isManager) {
                    // Add client ID and name to each result for tracking
                    const resultsWithClient = clientResult.results.map((r)=>({
                            ...r,
                            _clientCustomerId: client.id,
                            _clientCustomerName: client.name
                        }));
                    allResults.push(...resultsWithClient);
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info(`Fetched ${clientResult.results.length} campaign records from client ${client.id}`);
                }
            } catch (err) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].warn(`Failed to fetch from client ${client.id}: ${err.message}`);
            }
        }
    ...
    // No results found
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('No Google Ads campaigns found');
    return {
        results: []
    };
}
function transformGoogleAdsData(apiData) {
    const campaigns = [];
    const metrics = [];
    ...
    rows.forEach((row)=>{
        ...
        metrics.push({
            ...
            revenue: campaignMetrics.conversionsValue ? Number(campaignMetrics.conversionsValue) : 0
        });
    });
...
//# sourceMappingURL=_e0dc3b9e._.js.map