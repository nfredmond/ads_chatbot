...
"[project]/lib/linkedin-ads/client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function getLinkedInHeaders(accessToken, apiVersion) {
    return {
...
async function fetchLinkedInAdsCampaigns(config) {
    const apiVersion = config.apiVersion ?? DEFAULT_API_VERSION;
    const headers = getLinkedInHeaders(config.accessToken, apiVersion);
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('Fetching LinkedIn Ads campaigns');
    ...
    const accountsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rate$2d$limiting$2f$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRateLimit"])('linkedin_ads', async ()=>{
        try {
            ...
            if (!accountsResponse.ok) {
                ...
                try {
                    ...
                    error = {
                        message: errorText || accountsResponse.statusText
                    };
                }
                ...
                if (accountsResponse.status === 401 || accountsResponse.status === 403) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('linkedin_ads', 'fetchAdAccounts', new Error('Access token expired or invalid. Please reconnect your LinkedIn Ads account.'), accountsResponse.status, error.code?.toString());
                }
                // Rate limit errors
                if (accountsResponse.status === 429) {
                    const retryAfter = accountsResponse.headers.get('Retry-After');
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('linkedin_ads', 'fetchAdAccounts', new Error(`Rate limit exceeded. Retry after ${retryAfter || 'some time'}`), accountsResponse.status, error.code?.toString());
                }
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('linkedin_ads', 'fetchAdAccounts', new Error(errorMessage), accountsResponse.status, error.code?.toString());
            }
            ...
            // Wrap other errors
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('linkedin_ads', 'fetchAdAccounts', error, undefined, undefined);
        }
    });
    ...
    const accountUrn = adAccountId.toString().startsWith('urn:li:sponsoredAccount:') ? adAccountId.toString() : `urn:li:sponsoredAccount:${adAccountId}`;
    const campaignsUrl = `${LINKEDIN_API_BASE}/rest/adCampaigns?q=search&search=(account:(values:List(${accountUrn})))&count=100`;
    const campaignsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rate$2d$limiting$2f$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRateLimit"])('linkedin_ads', async ()=>{
        try {
            ...
            if (!campaignsResponse.ok) {
                ...
                try {
                    ...
                    error = {
                        message: errorText || campaignsResponse.statusText
                    };
                }
                ...
                if (campaignsResponse.status === 401 || campaignsResponse.status === 403) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('linkedin_ads', 'fetchCampaigns', new Error('Access token expired or invalid. Please reconnect your LinkedIn Ads account.'), campaignsResponse.status, error.code?.toString());
                }
                // Rate limit errors
                if (campaignsResponse.status === 429) {
                    const retryAfter = campaignsResponse.headers.get('Retry-After');
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('linkedin_ads', 'fetchCampaigns', new Error(`Rate limit exceeded. Retry after ${retryAfter || 'some time'}`), campaignsResponse.status, error.code?.toString());
                }
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('linkedin_ads', 'fetchCampaigns', new Error(errorMessage), campaignsResponse.status, error.code?.toString());
            }
            ...
            // Wrap other errors
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlatformAPIError"]('linkedin_ads', 'fetchCampaigns', error, undefined, undefined);
        }
    });
    if (!campaignsData.elements || campaignsData.elements.length === 0) {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('No LinkedIn campaigns found');
        return [];
    }
    // Step 3: Fetch analytics for campaigns (batch request for efficiency)
    const dateRange = getDateRange();
    const campaignIds = campaignsData.elements.map((c)=>c.id);
    ...
    const analyticsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rate$2d$limiting$2f$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRateLimit"])('linkedin_ads', async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].warn('LinkedIn analytics fetch failed, continuing without analytics', {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].warn('LinkedIn analytics fetch error, continuing without analytics', {
                error
            });
            return {
                elements: []
    ...
    const analyticsMap = new Map(analyticsData.elements?.map((a)=>[
            a.pivotValues?.[0],
            a
        ]) || []);
    const campaignsWithMetrics = campaignsData.elements.map((campaign)=>({
            ...campaign,
            analytics: analyticsMap.get(campaign.id) || null
        }));
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAPISuccess"])('linkedin_ads', 'fetchCampaigns', {
        campaignCount: campaignsWithMetrics.length,
        withAnalytics: campaignsWithMetrics.filter((c)=>c.analytics).length
    });
    return campaignsWithMetrics;
}
function transformLinkedInAdsData(apiData) {
    const campaigns = [];
    const metrics = [];
    apiData.forEach((campaign)=>{
        campaigns.push({
            campaign_id: campaign.id.toString(),
            campaign_name: campaign.name,
            platform: 'linkedin_ads',
            status: normalizeLinkedInStatus(campaign.status),
            budget_amount: campaign.dailyBudget?.amount ? parseFloat(campaign.dailyBudget.amount) : null
        });
...
function normalizeLinkedInStatus(status) {
    const statusMap = {
        'ACTIVE': 'active',
        'PAUSED': 'paused',
        'ARCHIVED': 'archived',
...
//# sourceMappingURL=_ddd01e35._.js.map